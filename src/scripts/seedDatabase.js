...
const seedData = async () => {
  try {
    ...
    const regularUserId = new ObjectId('6911139946b6db8b77fe50a6');
    ...
    const messages = [
      {
        _id: new ObjectId('691114b0f9ff946a9ea9a36a'),
        sender: regularUserId,
        senderName: 'user',
        recipient: adminUserId,
        content: 'Hola! Quiero comprar 10 monitores.',
        conversationType: 'direct',
        conversationId:
          '6908d6a63b33e35e99a365ca_6911139946b6db8b77fe50a6',
        timestamp: new Date('2025-11-09T22:24:48.567Z'),
        __v: 0,
      },
      {
        _id: new ObjectId('691114b7f9ff946a9ea9a36f'),
        sender: adminUserId,
        senderName: 'admin',
        recipient: regularUserId,
        content: 'Claro, abrimos mañana',
        conversationType: 'direct',
        conversationId:
          '6908d6a63b33e35e99a365ca_6911139946b6db8b77fe50a6',
        timestamp: new Date('2025-11-09T22:24:55.542Z'),
        __v: 0,
      },
    ];

    await Message.insertMany(messages);
    console.log(`${messages.length} mensajes creados exitosamente`);
